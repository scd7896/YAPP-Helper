...
export const DESIRE_INIT = "DESIRE_INIT" as const;
...
export const SENDMAIL_USER_RESULT = "SENDMAIL_USER_RESULT" as const;
...
/** ModalTypes */
export const MODAL_OPEN = "@modal/open" as const;
